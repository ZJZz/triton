...
module attributes {"ttg.num-ctas" = 2 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:90", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @matmul_kernel(%a_ptr: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("a_ptr"(#loc)), %b_ptr: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("b_ptr"(#loc)), %c_ptr: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("c_ptr"(#loc)), %M: i32 loc("M"(#loc)), %N: i32 loc("N"(#loc)), %K: i32 loc("K"(#loc)), %stride_am: i32 loc("stride_am"(#loc)), %stride_ak: i32 loc("stride_ak"(#loc)), %stride_bk: i32 loc("stride_bk"(#loc)), %stride_bn: i32 loc("stride_bn"(#loc)), %stride_cm: i32 loc("stride_cm"(#loc)), %stride_cn: i32 loc("stride_cn"(#loc))) attributes {noinline = false} {
    ...
    %acc:3 = scf.for %k = %c0_i32 to %K step %c32_i32 iter_args(%b_ptrs_41 = %b_ptrs_31, %acc_42 = %cst, %a_ptrs_43 = %a_ptrs_20) -> (tensor<32x64x!tt.ptr<f16>, #blocked2>, tensor<64x64xf32, #mma>, tensor<64x32x!tt.ptr<f16>, #blocked>)  : i32 {
      ...
      %acc_46 = ttng.warp_group_dot %a_44, %b_45, %acc_42 {inputPrecision = 0 : i32} : !ttg.memdesc<64x32xf16, #shared, #smem> * !ttg.memdesc<32x64xf16, #shared1, #smem> -> tensor<64x64xf32, #mma> loc(#loc54)
      %a_ptrs_47 = arith.muli %stride_ak, %c32_i32 : i32 loc(#loc55)
      %a_ptrs_48 = tt.splat %a_ptrs_47 : i32 -> tensor<64x32xi32, #blocked> loc(#loc56)
      %a_ptrs_49 = tt.addptr %a_ptrs_43, %a_ptrs_48 : tensor<64x32x!tt.ptr<f16>, #blocked>, tensor<64x32xi32, #blocked> loc(#loc56)
      %b_ptrs_50 = arith.muli %stride_bk, %c32_i32 : i32 loc(#loc57)
      %b_ptrs_51 = tt.splat %b_ptrs_50 : i32 -> tensor<32x64xi32, #blocked2> loc(#loc58)
      %b_ptrs_52 = tt.addptr %b_ptrs_41, %b_ptrs_51 : tensor<32x64x!tt.ptr<f16>, #blocked2>, tensor<32x64xi32, #blocked2> loc(#loc58)
      scf.yield %b_ptrs_52, %acc_46, %a_ptrs_49 : tensor<32x64x!tt.ptr<f16>, #blocked2>, tensor<64x64xf32, #mma>, tensor<64x32x!tt.ptr<f16>, #blocked> loc(#loc2)
    } loc(#loc64)
