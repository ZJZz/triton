...
#loc64 = loc("acc"(#loc63))
module attributes {"ttg.num-ctas" = 2 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32, "ttg.total-num-warps" = 4 : i32} {
  ...
  ^bb2:  // pred: ^bb1
    ...
    %a_58 = ttg.local_alloc %a_57 : (tensor<64x32xf16, #blocked>) -> !ttg.memdesc<64x32xf16, #shared1, #smem> loc(#loc57)
    %b_59 = tt.load %b_ptrs_48 : tensor<32x64x!tt.ptr<f16>, #blocked2> loc(#loc58)
    %b_60 = ttg.local_alloc %b_59 : (tensor<32x64xf16, #blocked2>) -> !ttg.memdesc<32x64xf16, #shared2, #smem> loc(#loc58)
