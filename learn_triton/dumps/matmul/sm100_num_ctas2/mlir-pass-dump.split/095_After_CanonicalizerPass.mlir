...
module attributes {"ttg.num-ctas" = 2 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @matmul_kernel(%a_ptr: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("a_ptr"(#loc)), %b_ptr: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("b_ptr"(#loc)), %c_ptr: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("c_ptr"(#loc)), %M: i32 loc("M"(#loc)), %N: i32 loc("N"(#loc)), %K: i32 loc("K"(#loc)), %stride_am: i32 loc("stride_am"(#loc)), %stride_ak: i32 loc("stride_ak"(#loc)), %stride_bk: i32 loc("stride_bk"(#loc)), %stride_bn: i32 loc("stride_bn"(#loc)), %stride_cm: i32 loc("stride_cm"(#loc)), %stride_cn: i32 loc("stride_cn"(#loc))) attributes {noinline = false} {
    ...
    %acc_44 = ttg.memdesc_index %acc_36[%c0_i32] : !ttg.memdesc<2x2xi64, #shared, #smem, mutable> -> !ttg.memdesc<2xi64, #shared, #smem, mutable> loc(#loc64)
    ttng.tc_gen5_mma %a_41, %b_43, %acc, %false, %acc_39, %acc_44[%true] {is_async} : !ttg.memdesc<64x32xf16, #shared1, #smem>, !ttg.memdesc<32x64xf16, #shared2, #smem>, !ttg.memdesc<64x64xf32, #tmem, #ttng.tensor_memory, mutable>, !ttg.memdesc<2xi64, #shared, #smem, mutable> loc(#loc55)
    %a_ptrs_45 = tt.addptr %a_ptrs_20, %a_ptrs_33 : tensor<64x32x!tt.ptr<f16>, #blocked>, tensor<64x32xi32, #blocked> loc(#loc52)
    %b_ptrs_46 = tt.addptr %b_ptrs_31, %b_ptrs_35 : tensor<32x64x!tt.ptr<f16>, #blocked2>, tensor<32x64xi32, #blocked2> loc(#loc54)
    %acc_47 = arith.subi %K, %c32_i32 : i32 loc(#loc64)
    %acc_48:8 = scf.for %acc_62 = %c0_i32 to %acc_47 step %c32_i32 iter_args(%b_ptrs_63 = %b_ptrs_46, %a_ptrs_64 = %a_ptrs_45, %acc_65 = %c0_i32, %acc_66 = %c1_i32, %acc_67 = %acc_44, %acc_68 = %c0_i32, %a_69 = %a_41, %b_70 = %b_43) -> (tensor<32x64x!tt.ptr<f16>, #blocked2>, tensor<64x32x!tt.ptr<f16>, #blocked>, i32, i32, !ttg.memdesc<2xi64, #shared, #smem, mutable>, i32, !ttg.memdesc<64x32xf16, #shared1, #smem>, !ttg.memdesc<32x64xf16, #shared2, #smem>)  : i32 {
      ttng.wait_barrier %acc_67, %acc_68 deps %a_69, %b_70 : !ttg.memdesc<2xi64, #shared, #smem, mutable>, !ttg.memdesc<64x32xf16, #shared1, #smem>, !ttg.memdesc<32x64xf16, #shared2, #smem> loc(#loc55)
      %a_71 = tt.load %a_ptrs_64 : tensor<64x32x!tt.ptr<f16>, #blocked> loc(#loc57)
      %a_72 = ttg.local_alloc %a_71 : (tensor<64x32xf16, #blocked>) -> !ttg.memdesc<64x32xf16, #shared1, #smem> loc(#loc57)
      %b_73 = tt.load %b_ptrs_63 : tensor<32x64x!tt.ptr<f16>, #blocked2> loc(#loc58)
      %b_74 = ttg.local_alloc %b_73 : (tensor<32x64xf16, #blocked2>) -> !ttg.memdesc<32x64xf16, #shared2, #smem> loc(#loc58)
      %acc_75 = ttg.memdesc_index %acc_36[%acc_66] : !ttg.memdesc<2x2xi64, #shared, #smem, mutable> -> !ttg.memdesc<2xi64, #shared, #smem, mutable> loc(#loc64)
      ttng.tc_gen5_mma %a_72, %b_74, %acc, %true, %true, %acc_75[%true] {is_async} : !ttg.memdesc<64x32xf16, #shared1, #smem>, !ttg.memdesc<32x64xf16, #shared2, #smem>, !ttg.memdesc<64x64xf32, #tmem, #ttng.tensor_memory, mutable>, !ttg.memdesc<2xi64, #shared, #smem, mutable> loc(#loc55)
      %a_ptrs_76 = tt.addptr %a_ptrs_64, %a_ptrs_33 : tensor<64x32x!tt.ptr<f16>, #blocked>, tensor<64x32xi32, #blocked> loc(#loc52)
      %b_ptrs_77 = tt.addptr %b_ptrs_63, %b_ptrs_35 : tensor<32x64x!tt.ptr<f16>, #blocked2>, tensor<32x64xi32, #blocked2> loc(#loc54)
      %acc_78 = arith.xori %acc_65, %c1_i32 : i32 loc(#loc55)
      %acc_79 = arith.addi %acc_66, %c1_i32 : i32 loc(#loc55)
      %acc_80 = arith.cmpi sge, %acc_79, %c2_i32 : i32 loc(#loc55)
      %acc_81 = arith.select %acc_80, %c0_i32, %acc_79 : i32 loc(#loc55)
      %acc_82 = arith.select %acc_80, %acc_78, %acc_65 : i32 loc(#loc55)
      scf.yield %b_ptrs_77, %a_ptrs_76, %acc_82, %acc_81, %acc_75, %acc_65, %a_72, %b_74 : tensor<32x64x!tt.ptr<f16>, #blocked2>, tensor<64x32x!tt.ptr<f16>, #blocked>, i32, i32, !ttg.memdesc<2xi64, #shared, #smem, mutable>, i32, !ttg.memdesc<64x32xf16, #shared1, #smem>, !ttg.memdesc<32x64xf16, #shared2, #smem> loc(#loc64)
    } loc(#loc64)
    %acc_49 = arith.cmpi sgt, %K, %c0_i32 : i32 loc(#loc64)
    scf.if %acc_49 {
      ttng.wait_barrier %acc_48#4, %acc_48#5 deps %acc_48#6, %acc_48#7 : !ttg.memdesc<2xi64, #shared, #smem, mutable>, !ttg.memdesc<64x32xf16, #shared1, #smem>, !ttg.memdesc<32x64xf16, #shared2, #smem> loc(#loc55)
    } loc(#loc64)
    %acc_50 = ttg.memdesc_index %acc_36[%c0_i32] : !ttg.memdesc<2x2xi64, #shared, #smem, mutable> -> !ttg.memdesc<2xi64, #shared, #smem, mutable> loc(#loc64)
    ttng.inval_barrier %acc_50 : !ttg.memdesc<2xi64, #shared, #smem, mutable> loc(#loc64)
    %acc_51 = ttg.memdesc_index %acc_36[%c1_i32] : !ttg.memdesc<2x2xi64, #shared, #smem, mutable> -> !ttg.memdesc<2xi64, #shared, #smem, mutable> loc(#loc64)
    ttng.inval_barrier %acc_51 : !ttg.memdesc<2xi64, #shared, #smem, mutable> loc(#loc64)
    ttg.local_dealloc %acc_36 : !ttg.memdesc<2x2xi64, #shared, #smem, mutable> loc(#loc64)
    %acc_52 = ttng.tmem_load %acc : !ttg.memdesc<64x64xf32, #tmem, #ttng.tensor_memory, mutable> -> tensor<64x64xf32, #linear> loc(#loc55)
    %c = arith.truncf %acc_52 : tensor<64x64xf32, #linear> to tensor<64x64xf16, #linear> loc(#loc59)
    %c_ptrs = tt.splat %stride_cm : i32 -> tensor<64x1xi32, #blocked2> loc(#loc60)
    %c_ptrs_53 = arith.muli %c_ptrs, %a_ptrs_10 : tensor<64x1xi32, #blocked2> loc(#loc60)
    %c_ptrs_54 = tt.splat %c_ptr : !tt.ptr<f16> -> tensor<64x1x!tt.ptr<f16>, #blocked2> loc(#loc61)
    %c_ptrs_55 = tt.addptr %c_ptrs_54, %c_ptrs_53 : tensor<64x1x!tt.ptr<f16>, #blocked2>, tensor<64x1xi32, #blocked2> loc(#loc61)
    %c_ptrs_56 = tt.splat %stride_cn : i32 -> tensor<1x64xi32, #blocked2> loc(#loc62)
    %c_ptrs_57 = ttg.convert_layout %b_ptrs_25 : tensor<1x64xi32, #blocked1> -> tensor<1x64xi32, #blocked2> loc(#loc62)
    %c_ptrs_58 = arith.muli %c_ptrs_56, %c_ptrs_57 : tensor<1x64xi32, #blocked2> loc(#loc62)
    %c_ptrs_59 = tt.broadcast %c_ptrs_55 : tensor<64x1x!tt.ptr<f16>, #blocked2> -> tensor<64x64x!tt.ptr<f16>, #blocked2> loc(#loc61)
    %c_ptrs_60 = tt.broadcast %c_ptrs_58 : tensor<1x64xi32, #blocked2> -> tensor<64x64xi32, #blocked2> loc(#loc61)
    %c_ptrs_61 = tt.addptr %c_ptrs_59, %c_ptrs_60 : tensor<64x64x!tt.ptr<f16>, #blocked2>, tensor<64x64xi32, #blocked2> loc(#loc61)
    %0 = ttg.convert_layout %c : tensor<64x64xf16, #linear> -> tensor<64x64xf16, #blocked2> loc(#loc26)
    tt.store %c_ptrs_61, %0 : tensor<64x64x!tt.ptr<f16>, #blocked2> loc(#loc26)
    tt.return loc(#loc)
  } loc(#loc)
} loc(#loc)
#loc1 = loc(unknown)
