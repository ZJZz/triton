...
[triton-loop-pipeline]: Load %52 = tt.load %arg12 : tensor<64x32x!tt.ptr<f16>, #ttg.blocked<{sizePerThread = [1, 8], threadsPerWarp = [8, 4], warpsPerCTA = [4, 1], order = [1, 0]}>> has width 128
[triton-loop-pipeline]: Load %52 = tt.load %arg12 : tensor<64x32x!tt.ptr<f16>, #ttg.blocked<{sizePerThread = [1, 8], threadsPerWarp = [8, 4], warpsPerCTA = [4, 1], order = [1, 0]}>> considered for pipelining with distance 0
[triton-loop-pipeline]: Load %53 = tt.load %arg13 : tensor<32x64x!tt.ptr<f16>, #ttg.blocked<{sizePerThread = [1, 8], threadsPerWarp = [4, 8], warpsPerCTA = [4, 1], order = [1, 0]}>> has width 128
[triton-loop-pipeline]: Load %53 = tt.load %arg13 : tensor<32x64x!tt.ptr<f16>, #ttg.blocked<{sizePerThread = [1, 8], threadsPerWarp = [4, 8], warpsPerCTA = [4, 1], order = [1, 0]}>> considered for pipelining with distance 0
