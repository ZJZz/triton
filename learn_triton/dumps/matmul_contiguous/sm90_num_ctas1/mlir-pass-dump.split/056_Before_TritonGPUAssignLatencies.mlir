...
[triton-loop-pipeline]: Load %54 = tt.load %arg13 : tensor<32x64x!tt.ptr<f16>, #ttg.blocked<{sizePerThread = [1, 8], threadsPerWarp = [4, 8], warpsPerCTA = [4, 1], order = [1, 0]}>> has width 128
[triton-loop-pipeline]: Load %54 = tt.load %arg13 : tensor<32x64x!tt.ptr<f16>, #ttg.blocked<{sizePerThread = [1, 8], threadsPerWarp = [4, 8], warpsPerCTA = [4, 1], order = [1, 0]}>> considered for pipelining with distance 0
